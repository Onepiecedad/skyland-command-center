-- SCC-36 / SCC-39 — attribution (6 sep 2026)
--
-- 1. Bokningar stämplas med det utskick som senast nådde kontakten innan
--    bokningen gjordes (attributed_*), plus fält för betalningsbekräftelse och
--    provision — provisionsunderlaget per kund (SCC-39).
-- 2. v_outreach_funnel: en rad per enrollment med dimensioner (ort, doktrin,
--    textvariant, poäng, researchkostnad) och utfall (skickat, svar, klassat
--    intresse, bokning, affär). Grunden för "vilka orter/texter ger möten".
