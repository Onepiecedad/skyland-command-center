...
// 'claw:main' = fritt uppdrag till huvud-Alex på VPS:en (delegate_task från
// panelen). Alla skills, samma agent som svarar på WhatsApp.
const CLAW_EXECUTOR_ALLOWLIST = ['claw:research', 'claw:prospect-finder', 'claw:content', 'claw:deep-research', 'claw:report-writer', 'claw:produce-package', 'claw:notify', 'claw:main'];
